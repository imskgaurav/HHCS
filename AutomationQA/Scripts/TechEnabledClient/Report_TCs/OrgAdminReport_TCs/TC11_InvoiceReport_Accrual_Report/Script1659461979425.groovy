...
import pages.AccrualReportPageSteps
...
String downloadedReportName = 'rptAccuralTimesheet'

AccrualReportPageSteps.ReportDownloadAndMatch(downloadedReportName, startDate, endDate)
